...
SOURCEFILES_QUOTED_IF_SPACED=Lab07_main.c BOARD.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Lab07_main.o ${OBJECTDIR}/BOARD.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Lab07_main.o.d ${OBJECTDIR}/BOARD.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Lab07_main.o ${OBJECTDIR}/BOARD.o

# Source Files
SOURCEFILES=Lab07_main.c BOARD.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Lab07_main.o: Lab07_main.c  .generated_files/flags/default/cc699936d61b9027cab67cc77e8443e20dc003e0 .generated_files/flags/default/af031a62ccc0c18b099f063c5edfd8e7f9b606f2
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Lab07_main.o.d 
	@${RM} ${OBJECTDIR}/Lab07_main.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -fno-common -Wall -MP -MMD -MF "${OBJECTDIR}/Lab07_main.o.d" -o ${OBJECTDIR}/Lab07_main.o Lab07_main.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	
${OBJECTDIR}/BOARD.o: BOARD.c  .generated_files/flags/default/732bea92a2d0b8ebe6fec36d061f270591483e36 .generated_files/flags/default/af031a62ccc0c18b099f063c5edfd8e7f9b606f2
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/Lab07_main.o: Lab07_main.c  .generated_files/flags/default/61b9f24660b6b12813a351eba95251db927863db .generated_files/flags/default/af031a62ccc0c18b099f063c5edfd8e7f9b606f2
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Lab07_main.o.d 
	@${RM} ${OBJECTDIR}/Lab07_main.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -fno-common -Wall -MP -MMD -MF "${OBJECTDIR}/Lab07_main.o.d" -o ${OBJECTDIR}/Lab07_main.o Lab07_main.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	
${OBJECTDIR}/BOARD.o: BOARD.c  .generated_files/flags/default/309fe4321e38b9cef788c262053915749a36b9e8 .generated_files/flags/default/af031a62ccc0c18b099f063c5edfd8e7f9b606f2
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/BOARD.o.d 
	@${RM} ${OBJECTDIR}/BOARD.o 
