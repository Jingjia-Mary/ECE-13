/* 
 * This file contains the implement functions for leds.
 * File:   Leds_Lab06.c
 * 
 * Author: Mary Xu
 *
 * Created on May 2, 2022, 2:37 PM
 */
...
void LEDS_INIT(void){
    TRISE = 0x00;
    LATE = 0x00; //declare the leds light
}
...
void LEDS_SET(char newPattern){
    LATE = newPattern; //declare that the late with pattern
}
 ...
 */
char LEDS_GET(void){
    return LATE; //return the value for led
}