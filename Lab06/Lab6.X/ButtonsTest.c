/* 
 * This file contains the test case functions for buttons.
 * File:   ButtonsTest.c
 * 
 * Author: Mary Xu
 *
 * Edited on May 5, 2022, 6:40 PM
 */
...
int main(void) {
     ...
     **************************************************************************************************/
    printf("Welcome to Mary's lab6 part4 (ButtonsTest).  Compiled on %s %s.\n", __TIME__, __DATE__);
...
void __ISR(_TIMER_1_VECTOR, ipl4auto) Timer1Handler(void) {
     ...
     * Your code goes in between this comment and the following one with asterisks.
     **************************************************************************************************/
    button = ButtonsCheckEvents(); // check the TITF for the button
